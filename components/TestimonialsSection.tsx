    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <p className="text-blue-600 font-semibold text-sm uppercase tracking-wide mb-2">Testimonials</p>
            ...
            >
              ...
              <div className="flex items-center gap-3 mt-6 pt-5 border-t border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-600 font-medium mt-0.5">{t.loan}</p>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="mt-12 text-center">
          <div className="inline-flex items-center gap-3 bg-white border border-gray-200 rounded-2xl px-8 py-4 shadow-sm">
            <div className="flex -space-x-2">
              {['bg-purple-400', 'bg-blue-400', 'bg-green-400', 'bg-yellow-400'].map((color, i) => (
            ...
            <div className="text-left">
              <p className="font-bold text-gray-900 text-sm">2,00,000+ Happy Customers</p>
