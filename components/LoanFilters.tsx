  ...
  return (
    <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm sticky top-20">
      ...
      <div className="space-y-7">
        <div>
          <div className="flex justify-between mb-2">
            ...
            <span className="text-sm font-bold text-navy">{maxRate}% p.a.</span>
          </div>
          <input
            type="range"
            min="8"
              ...
              <button
                ...
                className={`w-full text-left px-4 py-2.5 rounded-xl text-sm font-medium transition-all ${
                  minAmount === option.value
                    ...
                    : 'bg-gray-50 text-gray-600 hover:bg-navy-50 hover:text-navy'
                }`}
              >
                {option.label}
              </button>
      ...
      <button
        ...
        className="w-full mt-6 text-sm text-gray-500 hover:text-navy font-medium py-2 border border-gray-200 rounded-xl hover:border-navy-100 transition-colors"
      >
        Reset Filters
      </button>
    </div>
