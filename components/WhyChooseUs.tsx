const reasons = [
  {
    ...
    description: 'Compare loans from SBI, HDFC, ICICI, Axis, Bajaj Finance, Tata Capital, and 44+ more lenders — all in one place.',
  },
  {
    icon: (
      <svg className="w-7 h-7 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <p className="text-blue-600 font-semibold text-sm uppercase tracking-wide mb-2">Why Us</p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-7">
          {reasons.map((reason, idx) => (
            ...
            >
              <div className="w-13 h-13 bg-blue-50 rounded-xl flex items-center justify-center mb-4 p-3 group-hover:bg-blue-100 transition-colors w-fit">
                {reason.icon}
              </div>
